        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Tambahkan kategori untuk mengelompokkan buku berdasarkan mata pelajaran atau jenis koleksi.
                </p>
            </div>
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-emerald-50">
                                Kategori membantu pustakawan mengelompokkan koleksi buku dengan lebih rapi.
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <section class="rounded-3xl border border-emerald-100 bg-emerald-50/50 p-5 md:p-6">
                            <div class="mb-5 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Isi nama kategori dan deskripsi singkat agar mudah dipahami.
                                    </p>
                                </div>
                            </div>
