        ...
        <div class="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-gray-500">
                    Masukkan data buku induk yang akan disimpan ke katalog perpustakaan.
                </p>
            </div>
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="overflow-hidden rounded-[2rem] border border-white/70 bg-white/75 backdrop-blur-xl shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
                    ...
                    <div class="relative flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p class="mt-1 text-sm text-emerald-50">
                                Lengkapi informasi buku agar mudah dikelola dan dicari di sistem.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8">
                    <form method="POST" action="{{ route('books.store') }}" class="space-y-8">
                        @csrf
                        ...
                        <section class="rounded-3xl border border-emerald-100 bg-emerald-50/50 p-5 md:p-6">
                            <div class="mb-5 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Data dasar buku yang akan tampil pada katalog.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                <div class="md:col-span-2">
                                    ...
                                    <input
                                        ...
                                        value="{{ old('title') }}"
                                        required
                                        placeholder="Contoh: Akidah dan Akhlak Jilid 1 Kelas VII"
                        ...
                        <section class="rounded-3xl border border-gray-100 bg-white p-5 md:p-6 shadow-sm">
                            <div class="mb-5 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Digunakan untuk pencarian buku dan penyusunan pada rak perpustakaan.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    @if($ddcClasses->isEmpty())
                                        <p class="mt-2 text-xs font-medium text-amber-700">
                                            Belum ada data kelas DDC. Tambahkan DDC terlebih dahulu.
                                        </p>
                                    @endif
                        ...
                        <section class="rounded-3xl border border-gray-100 bg-white p-5 md:p-6 shadow-sm">
                            <div class="mb-5 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="mt-1 text-sm text-gray-500">
                                        Tentukan apakah buku dapat dipinjam pulang atau hanya boleh dibaca di tempat.
                                    </p>
                                </div>
                            </div>
                                ...
                                <div>
                                    ...
                                    <div class="relative mt-2">
                                        <select
                                            ...
                                            class="block w-full appearance-none rounded-2xl border border-emerald-200 bg-emerald-50/60 px-4 py-3 pr-10 text-sm text-gray-900 shadow-sm transition focus:border-emerald-500 focus:ring-2 focus:ring-emerald-200"
                                        >
                                            <option value="1" {{ old('is_borrowable', '1') == '1' ? 'selected' : '' }}>
                                                Bisa Dipinjam
                                            </option>
                                            <option value="0" {{ old('is_borrowable') == '0' ? 'selected' : '' }}>
                                                Baca di Tempat
                                            </option>
                                        </select>
